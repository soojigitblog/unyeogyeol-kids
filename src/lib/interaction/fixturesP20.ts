    ...
    childEvidences: [
      {
        ...
        strength: "medium",
        source: { scope: "general", questionIds: ["q4_transition", "deep_q1_trans_meal"] },
      },
      {
        domain: "transition",
        axis: "transition_preference",
        ...
        strength: "medium",
        source: { scope: "general", questionIds: ["deep_q2_trans_leaving"] },
      },
      {
    ...
    childEvidences: [
      {
        ...
        strength: "medium",
        source: { scope: "general", questionIds: ["q1_new_environment"] },
      },
      {
        domain: "social_approach",
        axis: "social_warmup_style",
        patternId: "observes_then_joins",
        observedLabel: "친구들이 노는 모습을 지켜보다 익숙해지면 함께하는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q5_social_approach"] },
      },
    ],
    momAnswers: {
    ...
    childEvidences: [
      {
        ...
        patternId: "energized_by_praise",
        observedLabel: "칭찬을 들으면 신나서 더 적극적으로 참여하는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q7_praise"] },
      },
      {
        domain: "new_environment",
        axis: "needs_observation_time",
    ...
    childEvidences: [
      {
        ...
        patternId: "deep_single_focus",
        observedLabel: "한 가지 놀이에 오래 깊이 몰입하는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q6_play"] },
      },
      {
        domain: "rule_response",
        axis: "rule_negotiation_style",
        patternId: "reason_seeking",
        observedLabel: "규칙이나 이유에 대한 설명을 차분히 듣고 이해하려는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q8_rule"] },
      },
    ],
    momAnswers: {
      time_pressure_style: "opt_time_wait",
  ...
  // Fixture E: 28개월 (Band A), 관찰과 사주 불일치 (사주=Fire 외향 vs 관찰=신중/탐색)
  {
    ...
    childEvidences: [
      ...
      },
      {
        ...
        patternId: "seeks_reassurance",
        observedLabel: "마음이 놓일 때까지 곁에서 탐색하는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q9_emotional_expression"] },
      },
    ],
    momAnswers: {
      time_pressure_style: "opt_time_wait",
  ...
  // Fixture F: 모순되는 응답 (일반 활동에서는 유연 vs 특정 놀이에서는 마침표 고집)
  {
    ...
    childEvidences: [
      ...
      },
      {
        ...
        strength: "medium",
        source: { scope: "general", questionIds: ["deep_q1_trans_meal"] },
      },
    ],
    momAnswers: {
      time_pressure_style: "opt_time_notify",
    ...
    childEvidences: [
      {
        domain: "rule_response",
        axis: "rule_negotiation_style",
        patternId: "context_flexible",
        observedLabel: "상황과 분위기에 따라 유연하게 반응하는 모습",
        strength: "medium",
        source: { scope: "general", questionIds: ["q8_rule_response"] },
      },
      {
        domain: "transition",
        axis: "transition_preference",
    ...
    childEvidences: [
      {
        domain: "self_assertion",
        axis: "strong_self_direction",
        patternId: "asserts_but_negotiates",
