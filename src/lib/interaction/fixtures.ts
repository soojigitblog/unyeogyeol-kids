...
export const FAMILY_FIXTURES: FamilyFixture[] = [
  ...
  {
    fixtureId: "C",
    title: "도윤 (60개월 남아) - 감정 표현 큰 아이 × 설명이 먼저 나오는 외할머니",
    ...
    childEvidences: [
      ...
      },
      {
        ...
        patternId: "intense_emotional_burst",
  ...
  {
    fixtureId: "E",
    title: "지호 (28개월 남아) - 신중한 아이 × 묵묵히 기다려주는 큰이모 (LOW-FRICTION)",
